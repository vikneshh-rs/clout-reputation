  ...
  return (
    <DashboardLayout title="Security & Activity Logs" theme={theme} toggleTheme={toggleTheme}>
      ...
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          onClick={fetchLogs}
          className="inline-flex items-center space-x-1 px-2.5 py-1.5 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 text-[#1857D6] font-semibold text-[10px] transition-colors self-start sm:self-auto"
          ...
          <div className="flex flex-wrap gap-2 w-full xl:w-auto">
            ...
            <div className="relative flex-grow sm:flex-grow-0">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 w-full sm:w-56 text-xs border border-slate-200 rounded-xl bg-white focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10"
              />
            </div>
            ...
            <select
              ...
              className="text-xs border border-slate-200 rounded-xl bg-white px-2.5 py-1.5 focus:border-[#1857D6] focus:outline-none font-medium text-slate-700"
            >

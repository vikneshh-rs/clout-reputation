      ...
      <div className="bg-white/80 backdrop-blur-md border border-slate-100 rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
        ...
        <div className="p-4 bg-slate-50/20 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center space-x-2">
            <Clock size={16} className="text-[#1857D6]" />
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <div className="relative flex-grow sm:flex-grow-0">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 w-full sm:w-52 text-xs border border-slate-200 rounded-xl bg-white focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10"
              />
            </div>
            ...
            <select
              ...
              className="text-xs border border-slate-200 rounded-xl bg-white px-2.5 py-1.5 focus:border-[#1857D6] focus:outline-none"
            >
                  ...
                  <tr key={sub.id} className="hover:bg-slate-50/40 transition-colors">
                    ...
                    <td className="px-6 py-3.5 text-right">
                      <button
                        ...
                        className="inline-flex items-center space-x-1 px-2.5 py-1.5 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 text-[#1857D6] font-semibold text-[10px] transition-colors"
            ...
            <form onSubmit={handleSubscriptionSubmit}>
              <div className="p-6 space-y-4 text-xs">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs border border-slate-200 rounded-xl bg-white px-2.5 py-1.5 focus:border-[#1857D6] focus:outline-none font-medium text-black"
                  >
                      ...
                      return (
                        <button
                          ...
                          className={`p-2 border rounded font-semibold text-[10px] flex items-center gap-1.5 transition-colors ${
                            active
                              ? 'bg-blue-50 border-[#1857D6] text-[#1857D6]'
                ...
                {action === 'extend' && (
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      max="36"
                      className="w-full text-xs border border-slate-200 rounded-xl bg-white px-3 py-2 focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10"
                      required
                    />
              ...
              <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end space-x-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors"
                >

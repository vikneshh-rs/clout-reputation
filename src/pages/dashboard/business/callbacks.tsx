                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                    ...
                    {item.status !== 'RESOLVED' && (
                      <button
                        ...
                        disabled={actionLoadingId === item.id}
                        className="bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer justify-center"
                      >
                        Mark Resolved
                      </button>
                    )}

      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-md border border-slate-100 rounded-2xl overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.02)] p-6">
          <div className="flex items-center space-x-3 pb-4 border-b border-slate-100 mb-6">
            <div className="p-2.5 bg-blue-50/70 text-[#1857D6] rounded-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex border-b border-slate-100 mb-6">
                <button
                  ...
                  className={`flex-1 pb-3 text-xs font-bold uppercase tracking-wider border-b-2 text-center transition-all cursor-pointer ${verifyMethod === 'scan' ? 'border-[#1857D6] text-[#1857D6]' : 'border-transparent text-zinc-500'}`}
                >
                  1. Scan QR Sticker
                </button>
                <button
                  ...
                  className={`flex-1 pb-3 text-xs font-bold uppercase tracking-wider border-b-2 text-center transition-all cursor-pointer ${verifyMethod === 'manual' ? 'border-[#1857D6] text-[#1857D6]' : 'border-transparent text-zinc-500'}`}
                >
                  2. Enter Manually
                </button>
              </div>
                  ...
                  {cameraError ? (
                    <div className="p-6 bg-slate-50/50 border border-slate-100 rounded-2xl text-center space-y-4">
                      ...
                      <button
                        ...
                        className="bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer border-none mx-auto"
                      >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-slate-50/50 border border-slate-100 rounded-2xl space-y-3">
                        ...
                        <div className="flex gap-2">
                          <select
                            id="simulateQrSelect"
                            className="flex-1 text-xs border border-slate-200 rounded-xl bg-white px-2.5 py-1.5 focus:border-[#1857D6] focus:outline-none font-mono uppercase"
                          >
                          ...
                          <button
                            ...
                            className="bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer border-none whitespace-nowrap"
                          >
                            Simulate Scan
                          </button>
                        </div>
              ...
              {verifyMethod === 'manual' && (
                <form onSubmit={(e) => handleValidateQr(e)} className="space-y-6">
                  <div>
                    ...
                    <div className="mt-2 relative">
                      ...
                      <input
                        ...
                        className="w-full text-xs border border-slate-200 rounded-xl bg-white pl-10 pr-3 py-2 focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10 font-mono uppercase"
                  ...
                  <button
                    ...
                    className="w-full flex justify-center items-center bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-colors cursor-pointer border-none disabled:opacity-50 disabled:cursor-not-allowed"
                  >
            ...
            <div className="space-y-6">
              ...
              <div className="flex border-b border-slate-100 mb-6">
                <button
                  ...
                  className={`flex-1 pb-3 text-xs font-bold uppercase tracking-wider border-b-2 text-center transition-all cursor-pointer ${activeSubTab === 'existing' ? 'border-[#1857D6] text-[#1857D6]' : 'border-transparent text-zinc-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex-1 pb-3 text-xs font-bold uppercase tracking-wider border-b-2 text-center transition-all cursor-pointer ${activeSubTab === 'new' ? 'border-[#1857D6] text-[#1857D6]' : 'border-transparent text-zinc-500'}`}
                >
                ...
                <form onSubmit={handleAssignToExistingSubmit} className="space-y-6">
                  <div>
                    ...
                    <select
                      ...
                      className="mt-2 text-xs border border-slate-200 rounded-xl bg-white w-full px-3 py-2.5 focus:border-[#1857D6] focus:outline-none"
                    >
                      {businesses.length === 0 ? (
                  ...
                  <button
                    ...
                    className="w-full flex justify-center items-center bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-colors cursor-pointer border-none disabled:opacity-50"
                  >
                    {loading ? <Loader2 className="animate-spin h-4 w-4 mr-2" /> : null}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        className="mt-1.5 w-full text-xs border border-slate-200 rounded-xl bg-white px-3 py-2 focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="mt-1.5 text-xs border border-slate-200 rounded-xl bg-white w-full px-2.5 py-1.5 focus:border-[#1857D6] focus:outline-none"
                      >
            ...
            <form onSubmit={handleReplaceQr} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full text-xs border border-slate-200 rounded-xl bg-white px-3 py-2 focus:border-[#1857D6] focus:outline-none focus:ring-2 focus:ring-[#1857D6]/10 font-mono uppercase"
          ...
          {step === 3 && (
            <div className="text-center py-8 space-y-6">
              ...
              <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
                <button
                  onClick={resetForm}
                  className="inline-flex items-center space-x-1 px-4 py-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 text-[#1857D6] font-semibold text-[10px] transition-colors justify-center"
                >
                ...
                <button
                  ...
                  className="bg-[#1857D6] hover:bg-[#154fc4] text-white text-xs font-semibold px-4 py-2 rounded-xl flex items-center gap-1.5 transition-colors cursor-pointer border-none justify-center"
                >
                  Return to Dashboard
                </button>
              </div>

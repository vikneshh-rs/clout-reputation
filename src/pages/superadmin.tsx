...
export default function SuperAdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative font-sans transition-colors duration-200">
      <Head>
        <title>Administrator Sign In - Clout Reputation</title>
      </Head>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md flex flex-col items-center">
        <div className="w-full flex justify-start px-4 sm:px-0">
          <Link href="/" className="inline-flex items-center text-xs font-semibold text-slate-500 hover:text-slate-900 mb-6 transition-colors">
        ...
        <p className="mt-2 text-center text-xs sm:text-sm text-slate-500">
          Sign in to the Super Admin inventory & management portal
        </p>
      </div>

      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div className="bg-white/80 backdrop-blur-md py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-slate-200/50 transition-colors">
          {error && (
